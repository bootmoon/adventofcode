...
#puts two_pairs_of_two?("qjhvhtzxzqqjkmpb")
#puts "xxyxx"
#puts two_pairs_of_two?("xxyxx")
puts two_pairs_of_two?("aaaa")
...
p two_pairs_of_two?("qjhvhtzxzqqjkmpb")
p repeating_letter_with_space?("qjhvhtzxzqqjkmpb")
if two_pairs_of_two?("qjhvhtzxzqqjkmpb") && repeating_letter_with_space?("qjhvhtzxzqqjkmpb")
		puts true
	end